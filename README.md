...
* Base URL: [`http://65.1.167.139:8000/`](http://65.1.167.139:8000/)
* Health check: [`http://65.1.167.139:8000/healthz`](http://65.1.167.139:8000/healthz)
* Server-Sent Events: [`http://65.1.167.139:8000/sse`](http://65.1.167.139:8000/sse)
* Public IP: `65.1.167.139`
* Public DNS: `ec2-65-1-167-139.ap-south-1.compute.amazonaws.com`

**CloudFront (HTTPS)**  
* Not enabled for this deployment.

_Last updated: 2025-10-21 16:15:16Z_
