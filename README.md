...
* Base URL: [`http://3.110.199.248:8000/`](http://3.110.199.248:8000/)
* Health check: [`http://3.110.199.248:8000/healthz`](http://3.110.199.248:8000/healthz)
* Server-Sent Events: [`http://3.110.199.248:8000/sse`](http://3.110.199.248:8000/sse)
* Public IP: `3.110.199.248`
* Public DNS: `ec2-3-110-199-248.ap-south-1.compute.amazonaws.com`

**CloudFront (HTTPS)**  
* Not enabled for this deployment.

_Last updated: 2025-10-21 16:23:35Z_
